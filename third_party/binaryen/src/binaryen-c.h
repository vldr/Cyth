...
extern "C"
{
  ...
  BINARYEN_API BinaryenType BinaryenTypeCreate(BinaryenType* valueTypes, BinaryenIndex numTypes);
  ...
  BINARYEN_API BinaryenHeapType BinaryenHeapTypeGetBottom(BinaryenHeapType heapType);
  BINARYEN_API bool BinaryenHeapTypeIsSubType(BinaryenHeapType left, BinaryenHeapType right);
  BINARYEN_API BinaryenIndex BinaryenStructTypeGetNumFields(BinaryenHeapType heapType);
  BINARYEN_API BinaryenType BinaryenStructTypeGetFieldType(BinaryenHeapType heapType,
                                                           BinaryenIndex index);
  BINARYEN_API BinaryenPackedType BinaryenStructTypeGetFieldPackedType(BinaryenHeapType heapType,
                                                                       BinaryenIndex index);
  BINARYEN_API bool BinaryenStructTypeIsFieldMutable(BinaryenHeapType heapType,
                                                     BinaryenIndex index);
  BINARYEN_API BinaryenType BinaryenArrayTypeGetElementType(BinaryenHeapType heapType);
  BINARYEN_API BinaryenPackedType BinaryenArrayTypeGetElementPackedType(BinaryenHeapType heapType);
  BINARYEN_API bool BinaryenArrayTypeIsElementMutable(BinaryenHeapType heapType);
  BINARYEN_API BinaryenType BinaryenSignatureTypeGetParams(BinaryenHeapType heapType);
  BINARYEN_API BinaryenType BinaryenSignatureTypeGetResults(BinaryenHeapType heapType);
  ...
  BINARYEN_API BinaryenType BinaryenTypeFromHeapType(BinaryenHeapType heapType, bool nullable);
...
#include "wasm-delegations.def"
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenBlock(BinaryenModuleRef module, const char* name,
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenLoop(BinaryenModuleRef module, const char* in,
                                                  BinaryenExpressionRef body);
  // Break: value and condition can be NULL
  BINARYEN_API BinaryenExpressionRef BinaryenBreak(BinaryenModuleRef module, const char* name,
                                                   BinaryenExpressionRef condition,
                                                   BinaryenExpressionRef value);
  // Switch: value can be NULL
  BINARYEN_API BinaryenExpressionRef BinaryenSwitch(BinaryenModuleRef module, const char** names,
                                                    BinaryenIndex numNames, const char* defaultName,
                                                    BinaryenExpressionRef condition,
                                                    BinaryenExpressionRef value);
  ...
  //       know what it is.
  BINARYEN_API BinaryenExpressionRef BinaryenCall(BinaryenModuleRef module, const char* target,
                                                  BinaryenExpressionRef* operands,
                                                  BinaryenIndex numOperands,
                                                  BinaryenType returnType);
  BINARYEN_API BinaryenExpressionRef
  BinaryenCallIndirect(BinaryenModuleRef module, const char* table, BinaryenExpressionRef target,
                       BinaryenExpressionRef* operands, BinaryenIndex numOperands,
                       BinaryenType params, BinaryenType results);
  BINARYEN_API BinaryenExpressionRef BinaryenReturnCall(BinaryenModuleRef module,
                                                        const char* target,
                                                        BinaryenExpressionRef* operands,
                                                        BinaryenIndex numOperands,
                                                        BinaryenType returnType);
  BINARYEN_API BinaryenExpressionRef
  BinaryenReturnCallIndirect(BinaryenModuleRef module, const char* table,
                             BinaryenExpressionRef target, BinaryenExpressionRef* operands,
                             BinaryenIndex numOperands, BinaryenType params, BinaryenType results);
  ...
  //           for more details.
  BINARYEN_API BinaryenExpressionRef BinaryenLocalGet(BinaryenModuleRef module, BinaryenIndex index,
                                                      BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenLocalSet(BinaryenModuleRef module, BinaryenIndex index,
                                                      BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenLocalTee(BinaryenModuleRef module, BinaryenIndex index,
                                                      BinaryenExpressionRef value,
                                                      BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenGlobalGet(BinaryenModuleRef module, const char* name,
                                                       BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenGlobalSet(BinaryenModuleRef module, const char* name,
                                                       BinaryenExpressionRef value);
  // Load: align can be 0, in which case it will be the natural alignment (equal
  // to bytes)
  BINARYEN_API BinaryenExpressionRef BinaryenLoad(BinaryenModuleRef module, uint32_t bytes,
  ...
  // to bytes)
  BINARYEN_API BinaryenExpressionRef BinaryenStore(BinaryenModuleRef module, uint32_t bytes,
                                                   uint32_t offset, uint32_t align,
                                                   BinaryenExpressionRef ptr,
                                                   BinaryenExpressionRef value, BinaryenType type,
                                                   const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenConst(BinaryenModuleRef module,
                                                   struct BinaryenLiteral value);
  BINARYEN_API BinaryenExpressionRef BinaryenUnary(BinaryenModuleRef module, BinaryenOp op,
                                                   BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenBinary(BinaryenModuleRef module, BinaryenOp op,
                                                    BinaryenExpressionRef left,
                                                    BinaryenExpressionRef right);
  BINARYEN_API BinaryenExpressionRef BinaryenSelect(BinaryenModuleRef module,
                                                    BinaryenExpressionRef condition,
                                                    BinaryenExpressionRef ifTrue,
                                                    BinaryenExpressionRef ifFalse);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenMemorySize(BinaryenModuleRef module,
                                                        const char* memoryName, bool memoryIs64);
  BINARYEN_API BinaryenExpressionRef BinaryenMemoryGrow(BinaryenModuleRef module,
                                                        BinaryenExpressionRef delta,
                                                        const char* memoryName, bool memoryIs64);
  BINARYEN_API BinaryenExpressionRef BinaryenNop(BinaryenModuleRef module);
  BINARYEN_API BinaryenExpressionRef BinaryenUnreachable(BinaryenModuleRef module);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicLoad(BinaryenModuleRef module, uint32_t bytes,
                                                        uint32_t offset, BinaryenType type,
                                                        BinaryenExpressionRef ptr,
                                                        const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicStore(BinaryenModuleRef module, uint32_t bytes,
                                                         uint32_t offset, BinaryenExpressionRef ptr,
                                                         BinaryenExpressionRef value,
                                                         BinaryenType type, const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicRMW(BinaryenModuleRef module, BinaryenOp op,
                                                       BinaryenIndex bytes, BinaryenIndex offset,
                                                       BinaryenExpressionRef ptr,
                                                       BinaryenExpressionRef value,
                                                       BinaryenType type, const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicCmpxchg(
    BinaryenModuleRef module, BinaryenIndex bytes, BinaryenIndex offset, BinaryenExpressionRef ptr,
    BinaryenExpressionRef expected, BinaryenExpressionRef replacement, BinaryenType type,
    const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicWait(BinaryenModuleRef module,
                                                        BinaryenExpressionRef ptr,
                                                        BinaryenExpressionRef expected,
                                                        BinaryenExpressionRef timeout,
                                                        BinaryenType type, const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicNotify(BinaryenModuleRef module,
                                                          BinaryenExpressionRef ptr,
                                                          BinaryenExpressionRef notifyCount,
                                                          const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenAtomicFence(BinaryenModuleRef module);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDExtract(BinaryenModuleRef module, BinaryenOp op,
                                                         BinaryenExpressionRef vec, uint8_t index);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDReplace(BinaryenModuleRef module, BinaryenOp op,
                                                         BinaryenExpressionRef vec, uint8_t index,
                                                         BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDShuffle(BinaryenModuleRef module,
                                                         BinaryenExpressionRef left,
                                                         BinaryenExpressionRef right,
                                                         const uint8_t mask[16]);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDTernary(BinaryenModuleRef module, BinaryenOp op,
                                                         BinaryenExpressionRef a,
                                                         BinaryenExpressionRef b,
                                                         BinaryenExpressionRef c);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDShift(BinaryenModuleRef module, BinaryenOp op,
                                                       BinaryenExpressionRef vec,
                                                       BinaryenExpressionRef shift);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDLoad(BinaryenModuleRef module, BinaryenOp op,
                                                      uint32_t offset, uint32_t align,
                                                      BinaryenExpressionRef ptr, const char* name);
  BINARYEN_API BinaryenExpressionRef BinaryenSIMDLoadStoreLane(
    BinaryenModuleRef module, BinaryenOp op, uint32_t offset, uint32_t align, uint8_t index,
    BinaryenExpressionRef ptr, BinaryenExpressionRef vec, const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenMemoryInit(
    BinaryenModuleRef module, const char* segment, BinaryenExpressionRef dest,
    BinaryenExpressionRef offset, BinaryenExpressionRef size, const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenDataDrop(BinaryenModuleRef module,
                                                      const char* segment);
  BINARYEN_API BinaryenExpressionRef BinaryenMemoryCopy(
    BinaryenModuleRef module, BinaryenExpressionRef dest, BinaryenExpressionRef source,
    BinaryenExpressionRef size, const char* destMemory, const char* sourceMemory);
  BINARYEN_API BinaryenExpressionRef BinaryenMemoryFill(BinaryenModuleRef module,
                                                        BinaryenExpressionRef dest,
                                                        BinaryenExpressionRef value,
                                                        BinaryenExpressionRef size,
                                                        const char* memoryName);
  BINARYEN_API BinaryenExpressionRef BinaryenRefNull(BinaryenModuleRef module, BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenRefIsNull(BinaryenModuleRef module,
                                                       BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenRefAs(BinaryenModuleRef module, BinaryenOp op,
                                                   BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenRefFunc(BinaryenModuleRef module, const char* func,
                                                     BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenRefEq(BinaryenModuleRef module,
                                                   BinaryenExpressionRef left,
                                                   BinaryenExpressionRef right);
  BINARYEN_API BinaryenExpressionRef BinaryenTableGet(BinaryenModuleRef module, const char* name,
                                                      BinaryenExpressionRef index,
                                                      BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenTableSet(BinaryenModuleRef module, const char* name,
                                                      BinaryenExpressionRef index,
                                                      BinaryenExpressionRef value);
  BINARYEN_API BinaryenExpressionRef BinaryenTableSize(BinaryenModuleRef module, const char* name);
  BINARYEN_API BinaryenExpressionRef BinaryenTableGrow(BinaryenModuleRef module, const char* name,
                                                       BinaryenExpressionRef value,
                                                       BinaryenExpressionRef delta);
  // Try: name can be NULL. delegateTarget should be NULL in try-catch.
  BINARYEN_API BinaryenExpressionRef BinaryenTry(BinaryenModuleRef module, const char* name,
                                                 BinaryenExpressionRef body, const char** catchTags,
                                                 BinaryenIndex numCatchTags,
                                                 BinaryenExpressionRef* catchBodies,
                                                 BinaryenIndex numCatchBodies,
                                                 const char* delegateTarget);
  BINARYEN_API BinaryenExpressionRef BinaryenThrow(BinaryenModuleRef module, const char* tag,
                                                   BinaryenExpressionRef* operands,
                                                   BinaryenIndex numOperands);
  BINARYEN_API BinaryenExpressionRef BinaryenRethrow(BinaryenModuleRef module, const char* target);
  BINARYEN_API BinaryenExpressionRef BinaryenTupleMake(BinaryenModuleRef module,
                                                       BinaryenExpressionRef* operands,
                                                       BinaryenIndex numOperands);
  BINARYEN_API BinaryenExpressionRef BinaryenTupleExtract(BinaryenModuleRef module,
                                                          BinaryenExpressionRef tuple,
                                                          BinaryenIndex index);
  BINARYEN_API BinaryenExpressionRef BinaryenPop(BinaryenModuleRef module, BinaryenType type);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenI31Get(BinaryenModuleRef module,
                                                    BinaryenExpressionRef i31, bool signed_);
  BINARYEN_API BinaryenExpressionRef BinaryenCallRef(BinaryenModuleRef module,
                                                     BinaryenExpressionRef target,
                                                     BinaryenExpressionRef* operands,
                                                     BinaryenIndex numOperands, BinaryenType type,
                                                     bool isReturn);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenRefCast(BinaryenModuleRef module,
                                                     BinaryenExpressionRef ref, BinaryenType type);
  BINARYEN_API BinaryenExpressionRef BinaryenBrOn(BinaryenModuleRef module, BinaryenOp op,
                                                  const char* name, BinaryenExpressionRef ref,
                                                  BinaryenType castType);
  // Passing in null for |operands| (and 0 for |numOperands|) implies this is
  // struct.new_default.
  BINARYEN_API BinaryenExpressionRef BinaryenStructNew(BinaryenModuleRef module,
                                                       BinaryenExpressionRef* operands,
                                                       BinaryenIndex numOperands,
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenStructGet(BinaryenModuleRef module,
                                                       ...
                                                       BinaryenExpressionRef ref, BinaryenType type,
                                                       bool signed_);
  BINARYEN_API BinaryenExpressionRef BinaryenStructSet(BinaryenModuleRef module,
                                                       BinaryenIndex index,
                                                       BinaryenExpressionRef ref,
                                                       BinaryenExpressionRef value);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenArrayNewData(BinaryenModuleRef module,
                                                          BinaryenHeapType type, const char* name,
                                                          BinaryenExpressionRef offset,
                                                          BinaryenExpressionRef size);
  BINARYEN_API BinaryenExpressionRef BinaryenArrayNewFixed(BinaryenModuleRef module,
                                                           BinaryenHeapType type,
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenArrayLen(BinaryenModuleRef module,
                                                      BinaryenExpressionRef ref);
  BINARYEN_API BinaryenExpressionRef BinaryenArrayCopy(
    BinaryenModuleRef module, BinaryenExpressionRef destRef, BinaryenExpressionRef destIndex,
    BinaryenExpressionRef srcRef, BinaryenExpressionRef srcIndex, BinaryenExpressionRef length);
  BINARYEN_API BinaryenExpressionRef BinaryenStringNew(BinaryenModuleRef module, BinaryenOp op,
                                                       BinaryenExpressionRef ref,
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenStringConst(BinaryenModuleRef module,
                                                         const char* name);
  BINARYEN_API BinaryenExpressionRef BinaryenStringMeasure(BinaryenModuleRef module, BinaryenOp op,
                                                           BinaryenExpressionRef ref);
  BINARYEN_API BinaryenExpressionRef BinaryenStringEncode(BinaryenModuleRef module, BinaryenOp op,
                                                          BinaryenExpressionRef ref,
                                                          BinaryenExpressionRef ptr,
                                                          BinaryenExpressionRef start);
  BINARYEN_API BinaryenExpressionRef BinaryenStringConcat(BinaryenModuleRef module,
                                                          BinaryenExpressionRef left,
                                                          BinaryenExpressionRef right);
  BINARYEN_API BinaryenExpressionRef BinaryenStringEq(BinaryenModuleRef module, BinaryenOp op,
                                                      BinaryenExpressionRef left,
                                                      BinaryenExpressionRef right);
  BINARYEN_API BinaryenExpressionRef BinaryenStringWTF8Advance(BinaryenModuleRef module,
                                                               BinaryenExpressionRef ref,
                                                               BinaryenExpressionRef pos,
                                                               BinaryenExpressionRef bytes);
  BINARYEN_API BinaryenExpressionRef BinaryenStringWTF16Get(BinaryenModuleRef module,
                                                            BinaryenExpressionRef ref,
                                                            BinaryenExpressionRef pos);
  BINARYEN_API BinaryenExpressionRef BinaryenStringIterNext(BinaryenModuleRef module,
                                                            BinaryenExpressionRef ref);
  BINARYEN_API BinaryenExpressionRef BinaryenStringIterMove(BinaryenModuleRef module, BinaryenOp op,
                                                            BinaryenExpressionRef ref,
                                                            BinaryenExpressionRef num);
  BINARYEN_API BinaryenExpressionRef BinaryenStringSliceWTF(BinaryenModuleRef module,
                                                            BinaryenExpressionRef ref,
                                                            BinaryenExpressionRef start,
                                                            BinaryenExpressionRef end);
  BINARYEN_API BinaryenExpressionRef BinaryenStringSliceIter(BinaryenModuleRef module,
                                                             BinaryenExpressionRef ref,
                                                             BinaryenExpressionRef num);
  ...
  BINARYEN_API BinaryenExpressionId BinaryenExpressionGetId(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenExpressionSetType(BinaryenExpressionRef expr, BinaryenType type);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenExpressionCopy(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenBlockSetName(BinaryenExpressionRef expr, const char* name);
  // Gets the number of child expressions of a `block` expression.
  BINARYEN_API BinaryenIndex BinaryenBlockGetNumChildren(BinaryenExpressionRef expr);
  // Gets the child expression at the specified index of a `block` expression.
  BINARYEN_API BinaryenExpressionRef BinaryenBlockGetChildAt(BinaryenExpressionRef expr,
                                                             BinaryenIndex index);
  // Sets (replaces) the child expression at the specified index of a `block`
  // expression.
  BINARYEN_API void BinaryenBlockSetChildAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                            BinaryenExpressionRef childExpr);
  // Appends a child expression to a `block` expression, returning its insertion
  // index.
  BINARYEN_API BinaryenIndex BinaryenBlockAppendChild(BinaryenExpressionRef expr,
                                                      BinaryenExpressionRef childExpr);
  ...
  // up.
  BINARYEN_API void BinaryenBlockInsertChildAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                               BinaryenExpressionRef childExpr);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenBlockRemoveChildAt(BinaryenExpressionRef expr,
                                                                BinaryenIndex index);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenIfGetIfFalse(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenLoopSetName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API void BinaryenLoopSetBody(BinaryenExpressionRef expr, BinaryenExpressionRef bodyExpr);
  ...
  BINARYEN_API void BinaryenBreakSetName(BinaryenExpressionRef expr, const char* name);
  // Gets the condition expression, if any, of a `br_if` expression. No condition
  // indicates a `br` expression.
  BINARYEN_API BinaryenExpressionRef BinaryenBreakGetCondition(BinaryenExpressionRef expr);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenBreakGetValue(BinaryenExpressionRef expr);
  ...
  BINARYEN_API BinaryenIndex BinaryenSwitchGetNumNames(BinaryenExpressionRef expr);
  // Gets the name (target label) at the specified index of a `br_table`
  // expression.
  BINARYEN_API const char* BinaryenSwitchGetNameAt(BinaryenExpressionRef expr, BinaryenIndex index);
  // Sets the name (target label) at the specified index of a `br_table`
  // expression.
  BINARYEN_API void BinaryenSwitchSetNameAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                            const char* name);
  // Appends a name to a `br_table` expression, returning its insertion index.
  BINARYEN_API BinaryenIndex BinaryenSwitchAppendName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API void BinaryenSwitchInsertNameAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                               const char* name);
  ...
  BINARYEN_API const char* BinaryenSwitchGetDefaultName(BinaryenExpressionRef expr);
  // Sets the default name (target label), if any, of a `br_table` expression.
  BINARYEN_API void BinaryenSwitchSetDefaultName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenSwitchGetValue(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenCallSetTarget(BinaryenExpressionRef expr, const char* target);
  // Gets the number of operands of a `call` expression.
  BINARYEN_API BinaryenIndex BinaryenCallGetNumOperands(BinaryenExpressionRef expr);
  // Gets the operand expression at the specified index of a `call` expression.
  BINARYEN_API BinaryenExpressionRef BinaryenCallGetOperandAt(BinaryenExpressionRef expr,
                                                              BinaryenIndex index);
  // Sets the operand expression at the specified index of a `call` expression.
  BINARYEN_API void BinaryenCallSetOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                             BinaryenExpressionRef operandExpr);
  // Appends an operand expression to a `call` expression, returning its insertion
  // index.
  BINARYEN_API BinaryenIndex BinaryenCallAppendOperand(BinaryenExpressionRef expr,
                                                       BinaryenExpressionRef operandExpr);
  ...
  // up.
  BINARYEN_API void BinaryenCallInsertOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                BinaryenExpressionRef operandExpr);
  ...
  // expression.
  BINARYEN_API BinaryenExpressionRef BinaryenCallRemoveOperandAt(BinaryenExpressionRef expr,
                                                                 BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenCallSetReturn(BinaryenExpressionRef expr, bool isReturn);
  ...
  BINARYEN_API void BinaryenCallIndirectSetTarget(BinaryenExpressionRef expr,
                                                  BinaryenExpressionRef targetExpr);
  // Gets the table name of a `call_indirect` expression.
  BINARYEN_API const char* BinaryenCallIndirectGetTable(BinaryenExpressionRef expr);
  // Sets the table name of a `call_indirect` expression.
  BINARYEN_API void BinaryenCallIndirectSetTable(BinaryenExpressionRef expr, const char* table);
  // Gets the number of operands of a `call_indirect` expression.
  BINARYEN_API BinaryenIndex BinaryenCallIndirectGetNumOperands(BinaryenExpressionRef expr);
  // Gets the operand expression at the specified index of a `call_indirect`
  // expression.
  BINARYEN_API BinaryenExpressionRef BinaryenCallIndirectGetOperandAt(BinaryenExpressionRef expr,
                                                                      BinaryenIndex index);
  // Sets the operand expression at the specified index of a `call_indirect`
  // expression.
  BINARYEN_API void BinaryenCallIndirectSetOperandAt(BinaryenExpressionRef expr,
                                                     BinaryenIndex index,
                                                     BinaryenExpressionRef operandExpr);
  // Appends an operand expression to a `call_indirect` expression, returning its
  // insertion index.
  BINARYEN_API BinaryenIndex BinaryenCallIndirectAppendOperand(BinaryenExpressionRef expr,
                                                               BinaryenExpressionRef operandExpr);
  ...
  // index one index up.
  BINARYEN_API void BinaryenCallIndirectInsertOperandAt(BinaryenExpressionRef expr,
                                                        BinaryenIndex index,
                                                        BinaryenExpressionRef operandExpr);
  ...
  // operand expression.
  BINARYEN_API BinaryenExpressionRef BinaryenCallIndirectRemoveOperandAt(BinaryenExpressionRef expr,
                                                                         BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenCallIndirectSetReturn(BinaryenExpressionRef expr, bool isReturn);
  // Gets the parameter types of the specified `call_indirect` expression.
  BINARYEN_API BinaryenType BinaryenCallIndirectGetParams(BinaryenExpressionRef expr);
  // Sets the parameter types of the specified `call_indirect` expression.
  BINARYEN_API void BinaryenCallIndirectSetParams(BinaryenExpressionRef expr, BinaryenType params);
  // Gets the result types of the specified `call_indirect` expression.
  BINARYEN_API BinaryenType BinaryenCallIndirectGetResults(BinaryenExpressionRef expr);
  // Sets the result types of the specified `call_indirect` expression.
  BINARYEN_API void BinaryenCallIndirectSetResults(BinaryenExpressionRef expr, BinaryenType params);
  ...
  BINARYEN_API void BinaryenLocalGetSetIndex(BinaryenExpressionRef expr, BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenLocalSetSetIndex(BinaryenExpressionRef expr, BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenGlobalGetSetName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API void BinaryenGlobalSetSetName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API void BinaryenTableGetSetTable(BinaryenExpressionRef expr, const char* table);
  ...
  BINARYEN_API void BinaryenTableSetSetTable(BinaryenExpressionRef expr, const char* table);
  ...
  BINARYEN_API void BinaryenTableSizeSetTable(BinaryenExpressionRef expr, const char* table);
  ...
  BINARYEN_API void BinaryenTableGrowSetTable(BinaryenExpressionRef expr, const char* table);
  ...
  BINARYEN_API void BinaryenLoadSetAtomic(BinaryenExpressionRef expr, bool isAtomic);
  ...
  BINARYEN_API void BinaryenLoadSetSigned(BinaryenExpressionRef expr, bool isSigned);
  ...
  BINARYEN_API void BinaryenLoadSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  ...
  BINARYEN_API void BinaryenLoadSetBytes(BinaryenExpressionRef expr, uint32_t bytes);
  ...
  BINARYEN_API void BinaryenLoadSetAlign(BinaryenExpressionRef expr, uint32_t align);
  ...
  BINARYEN_API void BinaryenLoadSetPtr(BinaryenExpressionRef expr, BinaryenExpressionRef ptrExpr);
  ...
  BINARYEN_API void BinaryenStoreSetAtomic(BinaryenExpressionRef expr, bool isAtomic);
  ...
  BINARYEN_API void BinaryenStoreSetBytes(BinaryenExpressionRef expr, uint32_t bytes);
  ...
  BINARYEN_API void BinaryenStoreSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  ...
  BINARYEN_API void BinaryenStoreSetAlign(BinaryenExpressionRef expr, uint32_t align);
  ...
  BINARYEN_API void BinaryenStoreSetPtr(BinaryenExpressionRef expr, BinaryenExpressionRef ptrExpr);
  ...
  BINARYEN_API void BinaryenStoreSetValueType(BinaryenExpressionRef expr, BinaryenType valueType);
  ...
  BINARYEN_API void BinaryenConstSetValueI32(BinaryenExpressionRef expr, int32_t value);
  ...
  BINARYEN_API void BinaryenConstSetValueI64(BinaryenExpressionRef expr, int64_t value);
  ...
  // expression.
  BINARYEN_API void BinaryenConstSetValueI64Low(BinaryenExpressionRef expr, int32_t valueLow);
  ...
  // expression.
  BINARYEN_API void BinaryenConstSetValueI64High(BinaryenExpressionRef expr, int32_t valueHigh);
  ...
  BINARYEN_API void BinaryenConstSetValueF32(BinaryenExpressionRef expr, float value);
  ...
  BINARYEN_API void BinaryenConstSetValueF64(BinaryenExpressionRef expr, double value);
  // Reads the 128-bit vector value of a `v128.const` expression.
  BINARYEN_API void BinaryenConstGetValueV128(BinaryenExpressionRef expr, uint8_t* out);
  // Sets the 128-bit vector value of a `v128.const` expression.
  BINARYEN_API void BinaryenConstSetValueV128(BinaryenExpressionRef expr, const uint8_t value[16]);
  ...
  BINARYEN_API void BinaryenBinarySetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenReturnGetValue(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenAtomicRMWSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenAtomicRMWSetBytes(BinaryenExpressionRef expr, uint32_t bytes);
  ...
  BINARYEN_API void BinaryenAtomicRMWSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  ...
  // expression.
  BINARYEN_API void BinaryenAtomicCmpxchgSetBytes(BinaryenExpressionRef expr, uint32_t bytes);
  // Gets the constant offset of an atomic compare and exchange expression.
  BINARYEN_API uint32_t BinaryenAtomicCmpxchgGetOffset(BinaryenExpressionRef expr);
  // Sets the constant offset of an atomic compare and exchange expression.
  BINARYEN_API void BinaryenAtomicCmpxchgSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  ...
  // exchange expression.
  BINARYEN_API void BinaryenAtomicCmpxchgSetExpected(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenAtomicCmpxchgSetReplacement(BinaryenExpressionRef expr,
  ...
  // `memory.atomic.wait` expression.
  BINARYEN_API void BinaryenAtomicWaitSetExpected(BinaryenExpressionRef expr,
                                                  BinaryenExpressionRef expectedExpr);
  ...
  BINARYEN_API void BinaryenAtomicWaitSetTimeout(BinaryenExpressionRef expr,
                                                 BinaryenExpressionRef timeoutExpr);
  // Gets the expected type of an `memory.atomic.wait` expression.
  BINARYEN_API BinaryenType BinaryenAtomicWaitGetExpectedType(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenAtomicNotifySetNotifyCount(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenAtomicFenceSetOrder(BinaryenExpressionRef expr, uint8_t order);
  ...
  BINARYEN_API void BinaryenSIMDExtractSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenSIMDExtractSetIndex(BinaryenExpressionRef expr, uint8_t index);
  ...
  BINARYEN_API void BinaryenSIMDReplaceSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenSIMDReplaceSetIndex(BinaryenExpressionRef expr, uint8_t index);
  ...
  BINARYEN_API void BinaryenSIMDShuffleGetMask(BinaryenExpressionRef expr, uint8_t* mask);
  // Sets the 128-bit mask of a SIMD shuffle expression.
  BINARYEN_API void BinaryenSIMDShuffleSetMask(BinaryenExpressionRef expr, const uint8_t mask[16]);
  ...
  BINARYEN_API void BinaryenSIMDTernarySetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenSIMDShiftSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenSIMDLoadSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenSIMDLoadSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  ...
  BINARYEN_API void BinaryenSIMDLoadSetAlign(BinaryenExpressionRef expr, uint32_t align);
  ...
  BINARYEN_API BinaryenOp BinaryenSIMDLoadStoreLaneGetOp(BinaryenExpressionRef expr);
  // Sets the operation being performed by a SIMD load/store lane expression.
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  // Gets the constant offset of a SIMD load/store lane expression.
  BINARYEN_API uint32_t BinaryenSIMDLoadStoreLaneGetOffset(BinaryenExpressionRef expr);
  // Sets the constant offset of a SIMD load/store lane expression.
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetOffset(BinaryenExpressionRef expr, uint32_t offset);
  // Gets the byte alignment of a SIMD load/store lane expression.
  BINARYEN_API uint32_t BinaryenSIMDLoadStoreLaneGetAlign(BinaryenExpressionRef expr);
  // Sets the byte alignment of a SIMD load/store lane expression.
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetAlign(BinaryenExpressionRef expr, uint32_t align);
  // Gets the lane index of a SIMD load/store lane expression.
  BINARYEN_API uint8_t BinaryenSIMDLoadStoreLaneGetIndex(BinaryenExpressionRef expr);
  // Sets the lane index of a SIMD load/store lane expression.
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetIndex(BinaryenExpressionRef expr, uint8_t index);
  ...
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetPtr(BinaryenExpressionRef expr,
                                                    BinaryenExpressionRef ptrExpr);
  ...
  BINARYEN_API void BinaryenSIMDLoadStoreLaneSetVec(BinaryenExpressionRef expr,
                                                    BinaryenExpressionRef vecExpr);
  ...
  // expression.
  BINARYEN_API const char* BinaryenMemoryInitGetSegment(BinaryenExpressionRef expr);
  // Sets the name of the segment being initialized by a `memory.init`
  // expression.
  BINARYEN_API void BinaryenMemoryInitSetSegment(BinaryenExpressionRef expr, const char* segment);
  ...
  BINARYEN_API void BinaryenDataDropSetSegment(BinaryenExpressionRef expr, const char* segment);
  ...
  BINARYEN_API void BinaryenRefFuncSetFunc(BinaryenExpressionRef expr, const char* funcName);
  ...
  BINARYEN_API void BinaryenRefEqSetLeft(BinaryenExpressionRef expr, BinaryenExpressionRef left);
  ...
  BINARYEN_API void BinaryenRefEqSetRight(BinaryenExpressionRef expr, BinaryenExpressionRef right);
  ...
  BINARYEN_API void BinaryenTrySetName(BinaryenExpressionRef expr, const char* name);
  ...
  BINARYEN_API void BinaryenTrySetBody(BinaryenExpressionRef expr, BinaryenExpressionRef bodyExpr);
  // Gets the number of catch blocks (= the number of catch tags) of a `try`
  // expression.
  BINARYEN_API BinaryenIndex BinaryenTryGetNumCatchTags(BinaryenExpressionRef expr);
  // Gets the number of catch/catch_all blocks of a `try` expression.
  BINARYEN_API BinaryenIndex BinaryenTryGetNumCatchBodies(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenTrySetCatchTagAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                             const char* catchTag);
  ...
  BINARYEN_API void BinaryenTryInsertCatchTagAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                const char* catchTag);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenTryGetCatchBodyAt(BinaryenExpressionRef expr,
                                                               BinaryenIndex index);
  // Sets the catch body expression at the specified index of a `try` expression.
  BINARYEN_API void BinaryenTrySetCatchBodyAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                              BinaryenExpressionRef catchExpr);
  // Appends a catch expression to a `try` expression, returning its insertion
  // index.
  BINARYEN_API BinaryenIndex BinaryenTryAppendCatchBody(BinaryenExpressionRef expr,
                                                        BinaryenExpressionRef catchExpr);
  ...
  // index up.
  BINARYEN_API void BinaryenTryInsertCatchBodyAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                 BinaryenExpressionRef catchExpr);
  ...
  // expression.
  BINARYEN_API BinaryenExpressionRef BinaryenTryRemoveCatchBodyAt(BinaryenExpressionRef expr,
                                                                  BinaryenIndex index);
  ...
  BINARYEN_API const char* BinaryenTryGetDelegateTarget(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenThrowSetTag(BinaryenExpressionRef expr, const char* tagName);
  // Gets the number of operands of a `throw` expression.
  BINARYEN_API BinaryenIndex BinaryenThrowGetNumOperands(BinaryenExpressionRef expr);
  // Gets the operand at the specified index of a `throw` expression.
  BINARYEN_API BinaryenExpressionRef BinaryenThrowGetOperandAt(BinaryenExpressionRef expr,
                                                               BinaryenIndex index);
  // Sets the operand at the specified index of a `throw` expression.
  BINARYEN_API void BinaryenThrowSetOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                              BinaryenExpressionRef operandExpr);
  // Appends an operand expression to a `throw` expression, returning its
  // insertion index.
  BINARYEN_API BinaryenIndex BinaryenThrowAppendOperand(BinaryenExpressionRef expr,
                                                        BinaryenExpressionRef operandExpr);
  // Inserts an operand expression at the specified index of a `throw` expression,
  // moving existing operands including the one previously at that index one index
  // up.
  BINARYEN_API void BinaryenThrowInsertOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                 BinaryenExpressionRef operandExpr);
  // Removes the operand expression at the specified index of a `throw`
  // expression, moving all subsequent operands one index down. Returns the
  // operand expression.
  BINARYEN_API BinaryenExpressionRef BinaryenThrowRemoveOperandAt(BinaryenExpressionRef expr,
                                                                  BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenRethrowSetTarget(BinaryenExpressionRef expr, const char* target);

  // TupleMake

  // Gets the number of operands of a `tuple.make` expression.
  BINARYEN_API BinaryenIndex BinaryenTupleMakeGetNumOperands(BinaryenExpressionRef expr);
  // Gets the operand at the specified index of a `tuple.make` expression.
  BINARYEN_API BinaryenExpressionRef BinaryenTupleMakeGetOperandAt(BinaryenExpressionRef expr,
                                                                   BinaryenIndex index);
  // Sets the operand at the specified index of a `tuple.make` expression.
  BINARYEN_API void BinaryenTupleMakeSetOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                  BinaryenExpressionRef operandExpr);
  // Appends an operand expression to a `tuple.make` expression, returning its
  // insertion index.
  BINARYEN_API BinaryenIndex BinaryenTupleMakeAppendOperand(BinaryenExpressionRef expr,
                                                            BinaryenExpressionRef operandExpr);
  // Inserts an operand expression at the specified index of a `tuple.make`
  // expression, moving existing operands including the one previously at that
  // index one index up.
  BINARYEN_API void BinaryenTupleMakeInsertOperandAt(BinaryenExpressionRef expr,
                                                     BinaryenIndex index,
                                                     BinaryenExpressionRef operandExpr);
  // Removes the operand expression at the specified index of a `tuple.make`
  // expression, moving all subsequent operands one index down. Returns the
  // operand expression.
  BINARYEN_API BinaryenExpressionRef BinaryenTupleMakeRemoveOperandAt(BinaryenExpressionRef expr,
                                                                      BinaryenIndex index);
  ...
  BINARYEN_API BinaryenIndex BinaryenTupleExtractGetIndex(BinaryenExpressionRef expr);
  // Sets the index extracted at of a `tuple.extract` expression.
  BINARYEN_API void BinaryenTupleExtractSetIndex(BinaryenExpressionRef expr, BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenI31GetSetI31(BinaryenExpressionRef expr, BinaryenExpressionRef i31Expr);
  ...
  BINARYEN_API void BinaryenI31GetSetSigned(BinaryenExpressionRef expr, bool signed_);

  // CallRef

  BINARYEN_API BinaryenIndex BinaryenCallRefGetNumOperands(BinaryenExpressionRef expr);
  BINARYEN_API BinaryenExpressionRef BinaryenCallRefGetOperandAt(BinaryenExpressionRef expr,
                                                                 BinaryenIndex index);
  BINARYEN_API void BinaryenCallRefSetOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                BinaryenExpressionRef operandExpr);
  BINARYEN_API BinaryenIndex BinaryenCallRefAppendOperand(BinaryenExpressionRef expr,
                                                          BinaryenExpressionRef operandExpr);
  BINARYEN_API void BinaryenCallRefInsertOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                   BinaryenExpressionRef operandExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenCallRefRemoveOperandAt(BinaryenExpressionRef expr,
                                                                    BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenCallRefSetReturn(BinaryenExpressionRef expr, bool isReturn);
  ...
  BINARYEN_API BinaryenType BinaryenRefTestGetCastType(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenBrOnSetName(BinaryenExpressionRef expr, const char* nameStr);
  BINARYEN_API BinaryenExpressionRef BinaryenBrOnGetRef(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenBrOnSetRef(BinaryenExpressionRef expr, BinaryenExpressionRef refExpr);
  BINARYEN_API BinaryenType BinaryenBrOnGetCastType(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenBrOnSetCastType(BinaryenExpressionRef expr, BinaryenType castType);

  // StructNew

  BINARYEN_API BinaryenIndex BinaryenStructNewGetNumOperands(BinaryenExpressionRef expr);
  BINARYEN_API BinaryenExpressionRef BinaryenStructNewGetOperandAt(BinaryenExpressionRef expr,
                                                                   BinaryenIndex index);
  BINARYEN_API void BinaryenStructNewSetOperandAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                  BinaryenExpressionRef operandExpr);
  BINARYEN_API BinaryenIndex BinaryenStructNewAppendOperand(BinaryenExpressionRef expr,
                                                            BinaryenExpressionRef operandExpr);
  BINARYEN_API void BinaryenStructNewInsertOperandAt(BinaryenExpressionRef expr,
                                                     BinaryenIndex index,
                                                     BinaryenExpressionRef operandExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenStructNewRemoveOperandAt(BinaryenExpressionRef expr,
                                                                      BinaryenIndex index);

  // StructGet

  BINARYEN_API BinaryenIndex BinaryenStructGetGetIndex(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStructGetSetIndex(BinaryenExpressionRef expr, BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenStructGetSetSigned(BinaryenExpressionRef expr, bool signed_);

  // StructSet

  BINARYEN_API BinaryenIndex BinaryenStructSetGetIndex(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStructSetSetIndex(BinaryenExpressionRef expr, BinaryenIndex index);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenArrayNewGetInit(BinaryenExpressionRef expr);
  ...
  BINARYEN_API BinaryenIndex BinaryenArrayNewFixedGetNumValues(BinaryenExpressionRef expr);
  BINARYEN_API BinaryenExpressionRef BinaryenArrayNewFixedGetValueAt(BinaryenExpressionRef expr,
                                                                     BinaryenIndex index);
  BINARYEN_API void BinaryenArrayNewFixedSetValueAt(BinaryenExpressionRef expr, BinaryenIndex index,
                                                    BinaryenExpressionRef valueExpr);
  BINARYEN_API BinaryenIndex BinaryenArrayNewFixedAppendValue(BinaryenExpressionRef expr,
                                                              BinaryenExpressionRef valueExpr);
  BINARYEN_API void BinaryenArrayNewFixedInsertValueAt(BinaryenExpressionRef expr,
                                                       BinaryenIndex index,
                                                       BinaryenExpressionRef valueExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenArrayNewFixedRemoveValueAt(BinaryenExpressionRef expr,
                                                                        BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenArrayGetSetSigned(BinaryenExpressionRef expr, bool signed_);

  // ArraySet

  BINARYEN_API BinaryenExpressionRef BinaryenArraySetGetRef(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenArraySetSetRef(BinaryenExpressionRef expr,
                                           BinaryenExpressionRef refExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenArraySetGetIndex(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenArraySetSetIndex(BinaryenExpressionRef expr,
                                             BinaryenExpressionRef indexExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenArraySetGetValue(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenArrayCopySetDestRef(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenArrayCopySetDestIndex(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenArrayCopySetSrcIndex(BinaryenExpressionRef expr,
  ...
  BINARYEN_API void BinaryenStringNewSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  BINARYEN_API BinaryenExpressionRef BinaryenStringNewGetRef(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringNewSetRef(BinaryenExpressionRef expr,
                                            BinaryenExpressionRef ptrExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenStringNewGetStart(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringNewSetStart(BinaryenExpressionRef expr,
                                              BinaryenExpressionRef startExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenStringNewGetEnd(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringNewSetEnd(BinaryenExpressionRef expr,
                                            BinaryenExpressionRef endExpr);
  BINARYEN_API void BinaryenStringNewSetTry(BinaryenExpressionRef expr, bool try_);

  // StringConst

  BINARYEN_API const char* BinaryenStringConstGetString(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringConstSetString(BinaryenExpressionRef expr, const char* stringStr);

  // StringMeasure

  BINARYEN_API BinaryenOp BinaryenStringMeasureGetOp(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringMeasureSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenStringEncodeSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  BINARYEN_API BinaryenExpressionRef BinaryenStringEncodeGetStr(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringEncodeSetStr(BinaryenExpressionRef expr,
                                               BinaryenExpressionRef refExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenStringEncodeGetArray(BinaryenExpressionRef expr);
  BINARYEN_API void BinaryenStringEncodeSetArray(BinaryenExpressionRef expr,
                                                 BinaryenExpressionRef ptrExpr);
  BINARYEN_API BinaryenExpressionRef BinaryenStringEncodeGetStart(BinaryenExpressionRef expr);
  ...
  BINARYEN_API void BinaryenStringEqSetOp(BinaryenExpressionRef expr, BinaryenOp op);
  ...
  BINARYEN_API void BinaryenStringSliceWTFSetStart(BinaryenExpressionRef expr,
                                                   BinaryenExpressionRef startExpr);
  ...
  BINARYEN_API BinaryenFunctionRef BinaryenAddFunction(BinaryenModuleRef module, const char* name,
                                                       BinaryenType params, BinaryenType results,
  ...
  BINARYEN_API BinaryenFunctionRef BinaryenAddFunctionWithHeapType(
    BinaryenModuleRef module, const char* name, BinaryenHeapType type, BinaryenType* varTypes,
    BinaryenIndex numVarTypes, BinaryenExpressionRef body);
  // Gets a function reference by name. Returns NULL if the function does not
  // exist.
  BINARYEN_API BinaryenFunctionRef BinaryenGetFunction(BinaryenModuleRef module, const char* name);
  // Removes a function by name.
  BINARYEN_API void BinaryenRemoveFunction(BinaryenModuleRef module, const char* name);
  ...
  BINARYEN_API void BinaryenAddFunctionImport(BinaryenModuleRef module, const char* internalName,
                                              const char* externalModuleName,
                                              const char* externalBaseName, BinaryenType params,
                                              BinaryenType results);
  BINARYEN_API void BinaryenAddTableImport(BinaryenModuleRef module, const char* internalName,
                                           const char* externalModuleName,
                                           const char* externalBaseName);
  BINARYEN_API void BinaryenAddMemoryImport(BinaryenModuleRef module, const char* internalName,
                                            const char* externalModuleName,
                                            const char* externalBaseName, uint8_t shared);
  BINARYEN_API void BinaryenAddGlobalImport(BinaryenModuleRef module, const char* internalName,
                                            const char* externalModuleName,
                                            const char* externalBaseName, BinaryenType globalType,
                                            bool mutable_);
  BINARYEN_API void BinaryenAddTagImport(BinaryenModuleRef module, const char* internalName,
                                         const char* externalModuleName,
                                         const char* externalBaseName, BinaryenType params,
                                         BinaryenType results);
  ...
  BINARYEN_API BinaryenExportRef BinaryenAddFunctionExport(BinaryenModuleRef module,
                                                           const char* internalName,
                                                           const char* externalName);
  ...
  BINARYEN_API BinaryenExportRef BinaryenAddMemoryExport(BinaryenModuleRef module,
                                                         const char* internalName,
                                                         const char* externalName);
  // Adds a global export to the module.
  BINARYEN_API BinaryenExportRef BinaryenAddGlobalExport(BinaryenModuleRef module,
                                                         const char* internalName,
                                                         const char* externalName);
  ...
  BINARYEN_API void BinaryenRemoveExport(BinaryenModuleRef module, const char* externalName);
  ...
  BINARYEN_API BinaryenGlobalRef BinaryenAddGlobal(BinaryenModuleRef module, const char* name,
                                                   BinaryenType type, bool mutable_,
                                                   BinaryenExpressionRef init);
  // Gets a global reference by name. Returns NULL if the global does not exist.
  BINARYEN_API BinaryenGlobalRef BinaryenGetGlobal(BinaryenModuleRef module, const char* name);
  // Removes a global by name.
  BINARYEN_API void BinaryenRemoveGlobal(BinaryenModuleRef module, const char* name);
  ...
  BINARYEN_API BinaryenGlobalRef BinaryenGetGlobalByIndex(BinaryenModuleRef module,
                                                          BinaryenIndex index);
  ...
  BINARYEN_API BinaryenTagRef BinaryenAddTag(BinaryenModuleRef module, const char* name,
                                             BinaryenType params, BinaryenType results);
  // Gets a tag reference by name. Returns NULL if the tag does not exist.
  BINARYEN_API BinaryenTagRef BinaryenGetTag(BinaryenModuleRef module, const char* name);
  ...
  BINARYEN_API BinaryenTableRef BinaryenAddTable(BinaryenModuleRef module, const char* table,
                                                 BinaryenIndex initial, BinaryenIndex maximum,
                                                 BinaryenType tableType);
  BINARYEN_API void BinaryenRemoveTable(BinaryenModuleRef module, const char* table);
  BINARYEN_API BinaryenIndex BinaryenGetNumTables(BinaryenModuleRef module);
  BINARYEN_API BinaryenTableRef BinaryenGetTable(BinaryenModuleRef module, const char* name);
  ...
  BINARYEN_API BinaryenElementSegmentRef BinaryenAddActiveElementSegment(
    BinaryenModuleRef module, const char* table, const char* name, const char** funcNames,
    BinaryenIndex numFuncNames, BinaryenExpressionRef offset);
  BINARYEN_API BinaryenElementSegmentRef BinaryenAddPassiveElementSegment(
    BinaryenModuleRef module, const char* name, const char** funcNames, BinaryenIndex numFuncNames);
  BINARYEN_API void BinaryenRemoveElementSegment(BinaryenModuleRef module, const char* name);
  BINARYEN_API BinaryenIndex BinaryenGetNumElementSegments(BinaryenModuleRef module);
  BINARYEN_API BinaryenElementSegmentRef BinaryenGetElementSegment(BinaryenModuleRef module,
                                                                   const char* name);
  BINARYEN_API BinaryenElementSegmentRef BinaryenGetElementSegmentByIndex(BinaryenModuleRef module,
                                                                          BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenSetMemory(BinaryenModuleRef module, BinaryenIndex initial,
                                      BinaryenIndex maximum, const char* exportName,
                                      const char** segmentNames, const char** segmentDatas,
                                      bool* segmentPassives, BinaryenExpressionRef* segmentOffsets,
                                      BinaryenIndex* segmentSizes, BinaryenIndex numSegments,
                                      bool shared, bool memory64, const char* name);
  ...
  BINARYEN_API bool BinaryenMemoryIs64(BinaryenModuleRef module, const char* name);

  // Memory segments. Query utilities.

  BINARYEN_API uint32_t BinaryenGetNumMemorySegments(BinaryenModuleRef module);
  BINARYEN_API uint32_t BinaryenGetMemorySegmentByteOffset(BinaryenModuleRef module,
  ...
  BINARYEN_API bool BinaryenGetMemorySegmentPassive(BinaryenModuleRef module,
                                                    const char* segmentName);
  BINARYEN_API void BinaryenCopyMemorySegmentData(BinaryenModuleRef module, const char* segmentName,
                                                  char* buffer);
  BINARYEN_API void BinaryenAddDataSegment(BinaryenModuleRef module, const char* segmentName,
                                           const char* memoryName, bool segmentPassive,
                                           BinaryenExpressionRef segmentOffset,
                                           const char* segmentData, BinaryenIndex segmentSize);

  // Start function. One per module

  BINARYEN_API void BinaryenSetStart(BinaryenModuleRef module, BinaryenFunctionRef start);

  // Features

  // These control what features are allowed when validation and in passes.
  BINARYEN_API BinaryenFeatures BinaryenModuleGetFeatures(BinaryenModuleRef module);
  BINARYEN_API void BinaryenModuleSetFeatures(BinaryenModuleRef module, BinaryenFeatures features);
  ...
  BINARYEN_API void BinaryenModuleRunPasses(BinaryenModuleRef module, const char** passes,
  ...
  //         outputSize
  size_t BINARYEN_API BinaryenModuleWrite(BinaryenModuleRef module, char* output,
                                          size_t outputSize);

  // Serialize a module in s-expression text format.
  // @return how many bytes were written. This will be less than or equal to
  //         outputSize
  BINARYEN_API size_t BinaryenModuleWriteText(BinaryenModuleRef module, char* output,
                                              size_t outputSize);

  // Serialize a module in stack IR text format.
  // @return how many bytes were written. This will be less than or equal to
  //         outputSize
  BINARYEN_API size_t BinaryenModuleWriteStackIR(BinaryenModuleRef module, char* output,
                                                 size_t outputSize);
  ...
  //          outputSize
  BINARYEN_API BinaryenBufferSizes BinaryenModuleWriteWithSourceMap(BinaryenModuleRef module,
  ...
  BinaryenModuleAllocateAndWrite(BinaryenModuleRef module, const char* sourceMapUrl);
  ...
  // char* with malloc(), and expects the user to free() them manually
  // once not needed anymore.
  BINARYEN_API char* BinaryenModuleAllocateAndWriteStackIR(BinaryenModuleRef module);

  // Deserialize a module from binary form, assuming the MVP feature set.
  BINARYEN_API BinaryenModuleRef BinaryenModuleRead(char* input, size_t inputSize);
  ...
  BINARYEN_API const char* BinaryenModuleGetDebugInfoFileName(BinaryenModuleRef module,
                                                              BinaryenIndex index);
  ...
  // specified `Function`.
  BINARYEN_API BinaryenType BinaryenFunctionGetVar(BinaryenFunctionRef func, BinaryenIndex index);
  // Appends a local variable to the specified `Function`, returning its
  // index.
  BINARYEN_API BinaryenIndex BinaryenFunctionAddVar(BinaryenFunctionRef func, BinaryenType type);
  // Gets the number of locals within the specified function. Includes parameters.
  BINARYEN_API BinaryenIndex BinaryenFunctionGetNumLocals(BinaryenFunctionRef func);
  // Tests if the local at the specified index has a name.
  BINARYEN_API bool BinaryenFunctionHasLocalName(BinaryenFunctionRef func, BinaryenIndex index);
  ...
  BINARYEN_API void BinaryenFunctionSetLocalName(BinaryenFunctionRef func, BinaryenIndex index,
                                                 const char* name);
  // Gets the body of the specified `Function`.
  BINARYEN_API BinaryenExpressionRef BinaryenFunctionGetBody(BinaryenFunctionRef func);
  // Sets the body of the specified `Function`.
  BINARYEN_API void BinaryenFunctionSetBody(BinaryenFunctionRef func, BinaryenExpressionRef body);
  ...
  BINARYEN_API void BinaryenFunctionSetType(BinaryenFunctionRef func, BinaryenHeapType type);

  // Runs the standard optimization passes on the function. Uses the currently set
  // global optimize and shrink level.
  BINARYEN_API void BinaryenFunctionOptimize(BinaryenFunctionRef func, BinaryenModuleRef module);

  // Runs the specified passes on the function. Uses the currently set global
  // optimize and shrink level.
  BINARYEN_API void BinaryenFunctionRunPasses(BinaryenFunctionRef func, BinaryenModuleRef module,
  ...
  BINARYEN_API void BinaryenTableSetName(BinaryenTableRef table, const char* name);
  ...
  BINARYEN_API void BinaryenTableSetInitial(BinaryenTableRef table, BinaryenIndex initial);
  ...
  BINARYEN_API void BinaryenTableSetMax(BinaryenTableRef table, BinaryenIndex max);
  ...
  BINARYEN_API void BinaryenTableSetType(BinaryenTableRef table, BinaryenType tableType);
  ...
  BINARYEN_API const char* BinaryenElementSegmentGetName(BinaryenElementSegmentRef elem);
  // Sets the name of the specified `ElementSegment`.
  BINARYEN_API void BinaryenElementSegmentSetName(BinaryenElementSegmentRef elem, const char* name);
  // Gets the table name of the specified `ElementSegment`.
  BINARYEN_API const char* BinaryenElementSegmentGetTable(BinaryenElementSegmentRef elem);
  ...
  BINARYEN_API BinaryenIndex BinaryenElementSegmentGetLength(BinaryenElementSegmentRef elem);
  // Gets the item at the specified index
  BINARYEN_API const char* BinaryenElementSegmentGetData(BinaryenElementSegmentRef elem,
                                                         BinaryenIndex dataId);
  // Returns true if the specified elem segment is passive
  BINARYEN_API bool BinaryenElementSegmentIsPassive(BinaryenElementSegmentRef elem);
  ...
  BINARYEN_API BinaryenExpressionRef BinaryenGlobalGetInitExpr(BinaryenGlobalRef global);
  ...
  BINARYEN_API const char* BinaryenFunctionImportGetModule(BinaryenFunctionRef import);
  BINARYEN_API const char* BinaryenTableImportGetModule(BinaryenTableRef import);
  BINARYEN_API const char* BinaryenGlobalImportGetModule(BinaryenGlobalRef import);
  ...
  BINARYEN_API const char* BinaryenFunctionImportGetBase(BinaryenFunctionRef import);
  ...
  BINARYEN_API BinaryenExternalKind BinaryenExportGetKind(BinaryenExportRef export_);
  ...
  BINARYEN_API void BinaryenAddCustomSection(BinaryenModuleRef module, const char* name,
                                             const char* contents, BinaryenIndex contentsSize);
  ...
  BINARYEN_API BinaryenSideEffects BinaryenExpressionGetSideEffects(BinaryenExpressionRef expr,
                                                                    BinaryenModuleRef module);
...
typedef struct RelooperBlock* RelooperBlockRef;
  ...
  BINARYEN_API RelooperBlockRef RelooperAddBlock(RelooperRef relooper, BinaryenExpressionRef code);
  ...
  BINARYEN_API void RelooperAddBranch(RelooperBlockRef from, RelooperBlockRef to,
                                      BinaryenExpressionRef condition, BinaryenExpressionRef code);

  // Create a basic block that ends a switch on a condition
  BINARYEN_API RelooperBlockRef RelooperAddBlockWithSwitch(RelooperRef relooper,
  ...
  BINARYEN_API void RelooperAddBranchForSwitch(RelooperBlockRef from, RelooperBlockRef to,
                                               BinaryenIndex* indexes, BinaryenIndex numIndexes,
                                               BinaryenExpressionRef code);
  ...
  BINARYEN_API BinaryenExpressionRef RelooperRenderAndDispose(RelooperRef relooper,
...
typedef struct CExpressionRunner* ExpressionRunnerRef;
  ...
  BINARYEN_API bool ExpressionRunnerSetLocalValue(ExpressionRunnerRef runner, BinaryenIndex index,
                                                  BinaryenExpressionRef value);
  ...
  // will also happen (not affected by any flags). Returns `true` if the
  // expression actually evaluates to a constant.
  BINARYEN_API bool ExpressionRunnerSetGlobalValue(ExpressionRunnerRef runner, const char* name,
                                                   BinaryenExpressionRef value);
  ...
  BINARYEN_API BinaryenExpressionRef ExpressionRunnerRunAndDispose(ExpressionRunnerRef runner,
                                                                   BinaryenExpressionRef expr);
...
typedef struct TypeBuilder* TypeBuilderRef;
  ...
  BINARYEN_API TypeBuilderErrorReason TypeBuilderErrorReasonInvalidSupertype(void);
  // Indicates that the declared supertype is an invalid forward reference.
  BINARYEN_API TypeBuilderErrorReason TypeBuilderErrorReasonForwardSupertypeReference(void);
  // Indicates that a child of a type is an invalid forward reference.
  BINARYEN_API TypeBuilderErrorReason TypeBuilderErrorReasonForwardChildReference(void);
  ...
  // temporary types.
  BINARYEN_API void TypeBuilderSetSignatureType(TypeBuilderRef builder, BinaryenIndex index,
                                                BinaryenType paramTypes, BinaryenType resultTypes);
  // Sets the heap type at index `index` to a concrete struct type.
  BINARYEN_API void TypeBuilderSetStructType(TypeBuilderRef builder, BinaryenIndex index,
                                             BinaryenType* fieldTypes,
                                             BinaryenPackedType* fieldPackedTypes,
                                             bool* fieldMutables, int numFields);
  // Sets the heap type at index `index` to a concrete array type.
  BINARYEN_API void TypeBuilderSetArrayType(TypeBuilderRef builder, BinaryenIndex index,
  ...
  BINARYEN_API BinaryenType TypeBuilderGetTempTupleType(TypeBuilderRef builder, BinaryenType* types,
  ...
  BINARYEN_API BinaryenType TypeBuilderGetTempRefType(TypeBuilderRef builder,
                                                      BinaryenHeapType heapType, int nullable);
  // Sets the type at `index` to be a subtype of the given super type.
  BINARYEN_API void TypeBuilderSetSubType(TypeBuilderRef builder, BinaryenIndex index,
                                          BinaryenHeapType superType);
  // Sets the type at `index` to be open (i.e. non-final).
  BINARYEN_API void TypeBuilderSetOpen(TypeBuilderRef builder, BinaryenIndex index);
  // Creates a new recursion group in the range `index` inclusive to `index +
  // length` exclusive. Recursion groups must not overlap.
  BINARYEN_API void TypeBuilderCreateRecGroup(TypeBuilderRef builder, BinaryenIndex index,
  ...
  BINARYEN_API bool TypeBuilderBuildAndDispose(TypeBuilderRef builder, BinaryenHeapType* heapTypes,
  ...
  BINARYEN_API void BinaryenModuleSetFieldName(BinaryenModuleRef module, BinaryenHeapType heapType,
                                               BinaryenIndex index, const char* name);
