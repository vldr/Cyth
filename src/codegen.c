...
static Function* generate_array_reserve_function(DataType data_type)
{
  ...
  if (!function)
  {
...

    {
      ...
      generate_realloc_expression(MIR_new_reg_op(codegen.ctx, array_ptr),
                                  MIR_new_reg_op(codegen.ctx, array_ptr),
                                  MIR_new_reg_op(codegen.ctx, size));
...
static Function* generate_string_pad_function(void)
{
  ...
  if (!function)
  {
    ...
    MIR_load_external(codegen.ctx, name, (void*)string_pad);
    map_put_function(&codegen.functions, name, function);
  }
...
static Function* generate_string_concat_function(int count)
{
  ...
  if (!function)
  {
...

    {
      for (int i = 0; i < count; i++)
      {
        MIR_reg_t n_ptr = MIR_reg(codegen.ctx, params.elems[i].name, codegen.function->u.func);
        MIR_append_insn(
          codegen.ctx, codegen.function,
          MIR_new_insn(codegen.ctx, MIR_ADD, MIR_new_reg_op(codegen.ctx, size),
                       i == 0 ? MIR_new_int_op(codegen.ctx, 4) : MIR_new_reg_op(codegen.ctx, size),
                       generate_string_length_op(n_ptr)));
      }

      generate_malloc_expression(ptr, MIR_new_reg_op(codegen.ctx, size));

      MIR_append_insn(codegen.ctx, codegen.function,
                      MIR_new_insn(codegen.ctx, MIR_SUB, generate_string_length_op(ptr),
                                   MIR_new_reg_op(codegen.ctx, size),
                                   MIR_new_int_op(codegen.ctx, sizeof(unsigned int))));
    }

    {
      ...
      for (int i = 0; i < count; i++)
      {
        ...
        MIR_append_insn(codegen.ctx, codegen.function,
                        MIR_new_insn(codegen.ctx, MIR_MOV, MIR_new_reg_op(codegen.ctx, size),
                                     generate_string_length_op(n_ptr)));

        MIR_append_insn(codegen.ctx, codegen.function,
                        MIR_new_insn(codegen.ctx, MIR_ADD, MIR_new_reg_op(codegen.ctx, n_ptr),
                                     MIR_new_reg_op(codegen.ctx, n_ptr),
                                     MIR_new_int_op(codegen.ctx, sizeof(unsigned int))));
        ...
        MIR_append_insn(
          ...
          MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, codegen.memcpy.proto),
                            MIR_new_ref_op(codegen.ctx, codegen.memcpy.func),
                            MIR_new_reg_op(codegen.ctx, dest_ptr),
                            MIR_new_reg_op(codegen.ctx, n_ptr), MIR_new_reg_op(codegen.ctx, size)));
...
static void generate_binary_expression(MIR_reg_t dest, BinaryExpr* expression)
{
  ...
  {
    left = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(expression->operand_data_type),
                             codegen.function->u.func);
    right = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(expression->operand_data_type),
                              codegen.function->u.func);
  ...
  case TOKEN_PLUS:
    ...
    else if (data_type.type == TYPE_STRING)
    {
      ...
      ArrayMIR_op_t arguments;
      array_init(&arguments);
      array_add(&arguments, MIR_new_ref_op(codegen.ctx, string_concat->proto));
      array_add(&arguments, MIR_new_ref_op(codegen.ctx, string_concat->func));
      array_add(&arguments, MIR_new_reg_op(codegen.ctx, dest));
      ...
      {
        MIR_reg_t n =
          _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(expression->operand_data_type),
                            codegen.function->u.func);
...
static Function* generate_string_array_cast_function(DataType data_type)
{
  ...
  if (!function)
  {
    ...
    MIR_reg_t ptr = MIR_reg(codegen.ctx, "ptr", codegen.function->u.func);
    MIR_reg_t dest = MIR_reg(codegen.ctx, "dest", codegen.function->u.func);
    MIR_reg_t depth = MIR_reg(codegen.ctx, "depth", codegen.function->u.func);
    MIR_reg_t list = MIR_reg(codegen.ctx, "list", codegen.function->u.func);
...

    {
      ...
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_concat->proto),
                          MIR_new_ref_op(codegen.ctx, string_concat->func),
                          MIR_new_reg_op(codegen.ctx, dest), MIR_new_reg_op(codegen.ctx, dest),
                          MIR_new_reg_op(codegen.ctx, tmp)));

      MIR_append_insn(codegen.ctx, codegen.function,
                      MIR_new_insn(codegen.ctx, MIR_ADD, MIR_new_reg_op(codegen.ctx, depth),
                                   MIR_new_reg_op(codegen.ctx, depth),
                                   MIR_new_int_op(codegen.ctx, 1)));
    }

    {
      MIR_reg_t expr = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(element_data_type),
                                         codegen.function->u.func);
      ...
      MIR_append_insn(codegen.ctx, codegen.function,
                      MIR_new_insn(codegen.ctx, MIR_BGE, MIR_new_label_op(codegen.ctx, break_label),
                                   MIR_new_reg_op(codegen.ctx, i), generate_array_length_op(ptr)));
      ...
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_pad->proto),
                          MIR_new_ref_op(codegen.ctx, string_pad->func),
                          MIR_new_reg_op(codegen.ctx, tmp), MIR_new_reg_op(codegen.ctx, tmp),
                          MIR_new_reg_op(codegen.ctx, depth)));
...

      {
        ...
        MIR_append_insn(
          codegen.ctx, codegen.function,
          MIR_new_insn(codegen.ctx, MIR_BGE, MIR_new_label_op(codegen.ctx, if_false_label),
                       MIR_new_reg_op(codegen.ctx, i), generate_array_length_op(ptr)));
...
static Function* generate_string_object_cast_function(DataType data_type)
{
  ...
  if (!function)
  {
    ...
    MIR_reg_t tmp = _MIR_new_temp_reg(codegen.ctx, MIR_T_I64, codegen.function->u.func);
    MIR_reg_t tmp2 = _MIR_new_temp_reg(codegen.ctx, MIR_T_I64, codegen.function->u.func);
    MIR_reg_t tmp3 = _MIR_new_temp_reg(codegen.ctx, MIR_T_I64, codegen.function->u.func);

    {
      ...
      generate_string_literal_expression(MIR_new_reg_op(codegen.ctx, tmp), "null", -1);
...

    {
      ...
      MIR_append_insn(codegen.ctx, codegen.function,
                      MIR_new_insn(codegen.ctx, MIR_BGE, MIR_new_label_op(codegen.ctx, break_label),
                                   MIR_new_reg_op(codegen.ctx, i), generate_array_length_op(list)));

      MIR_reg_t expr = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(list_element_data_type),
                                         codegen.function->u.func);
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_insn(codegen.ctx, data_type_to_mov_type(list_element_data_type),
                     MIR_new_reg_op(codegen.ctx, expr),
                     MIR_new_mem_op(codegen.ctx,
                                    data_type_to_mir_array_type(list_element_data_type), 0,
...

      {
        ...
        MIR_append_insn(
          codegen.ctx, codegen.function,
          MIR_new_insn(codegen.ctx, MIR_BEQ, MIR_new_label_op(codegen.ctx, if_false_label),
                       MIR_new_reg_op(codegen.ctx, expr), MIR_new_reg_op(codegen.ctx, ptr)));
...

        {
          ...
          MIR_append_insn(codegen.ctx, codegen.function,
                          MIR_new_insn(codegen.ctx, MIR_BT,
                                       MIR_new_label_op(codegen.ctx, if_false_label),
                                       MIR_new_reg_op(codegen.ctx, i)));

          generate_string_literal_expression(MIR_new_reg_op(codegen.ctx, tmp), class->name.lexeme,
                                             -1);
          MIR_append_insn(
            codegen.ctx, codegen.function,
            MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_concat->proto),
          ...
          MIR_append_insn(
            codegen.ctx, codegen.function,
            MIR_new_call_insn(codegen.ctx, 4,
                              MIR_new_ref_op(codegen.ctx, codegen.string_int_cast.proto),
                              MIR_new_ref_op(codegen.ctx, codegen.string_int_cast.func),
                              MIR_new_reg_op(codegen.ctx, tmp), MIR_new_reg_op(codegen.ctx, i)));
          MIR_append_insn(
            codegen.ctx, codegen.function,
            MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_concat->proto),
                              MIR_new_ref_op(codegen.ctx, string_concat->func),
...

    {
      ...
      generate_string_literal_expression(MIR_new_reg_op(codegen.ctx, tmp), class->name.lexeme, -1);
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_concat->proto),
                          MIR_new_ref_op(codegen.ctx, string_concat->func),
      ...
      MIR_append_insn(codegen.ctx, codegen.function,
                      MIR_new_call_insn(
                        ...
                        MIR_new_ref_op(codegen.ctx, codegen.string_int_cast.func),
                        MIR_new_reg_op(codegen.ctx, tmp), generate_array_length_op(list)));
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 5, MIR_new_ref_op(codegen.ctx, string_concat->proto),
                          MIR_new_ref_op(codegen.ctx, string_concat->func),
    ...
    if (data_type.type == TYPE_OBJECT)
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, array_push->proto),
                          MIR_new_ref_op(codegen.ctx, array_push->func),
                          MIR_new_reg_op(codegen.ctx, list), MIR_new_reg_op(codegen.ctx, ptr)));

    VarStmt* variable;
    array_foreach(&class->variables, variable)
    {
      MIR_reg_t expr = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(variable->data_type),
                                         codegen.function->u.func);
      ...
      generate_string_literal_expression(MIR_new_reg_op(codegen.ctx, tmp2), "", -1);
      generate_string_cast(tmp2, expr, depth, list, variable->data_type);

      if (_i + 1 == class->variables.size)
        generate_string_literal_expression(MIR_new_reg_op(codegen.ctx, tmp3),
      ...
      MIR_append_insn(
        codegen.ctx, codegen.function,
        MIR_new_call_insn(codegen.ctx, 7, MIR_new_ref_op(codegen.ctx, string_concat_4->proto),
                          MIR_new_ref_op(codegen.ctx, string_concat_4->func),
                          MIR_new_reg_op(codegen.ctx, dest), MIR_new_reg_op(codegen.ctx, dest),
                          MIR_new_reg_op(codegen.ctx, tmp), MIR_new_reg_op(codegen.ctx, tmp2),
                          MIR_new_reg_op(codegen.ctx, tmp3)));
    }
                                 ...
                                 DataType data_type)
{
  ...
  case TYPE_BOOL:
    MIR_append_insn(
      codegen.ctx, codegen.function,
      MIR_new_call_insn(codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, codegen.string_bool_cast.proto),
  ...
  case TYPE_FLOAT:
    MIR_append_insn(codegen.ctx, codegen.function,
                    MIR_new_call_insn(
                      codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, codegen.string_float_cast.proto),
  ...
  case TYPE_INTEGER:
    MIR_append_insn(
      codegen.ctx, codegen.function,
      MIR_new_call_insn(codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, codegen.string_int_cast.proto),
                        MIR_new_ref_op(codegen.ctx, codegen.string_int_cast.func),
                        MIR_new_reg_op(codegen.ctx, dest), MIR_new_reg_op(codegen.ctx, expr)));
    return;
  case TYPE_CHAR:
    MIR_append_insn(
      codegen.ctx, codegen.function,
      MIR_new_call_insn(codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, codegen.string_char_cast.proto),
  ...
  case TYPE_ARRAY: {
    ...
    MIR_append_insn(
      codegen.ctx, codegen.function,
      MIR_new_call_insn(codegen.ctx, 7, MIR_new_ref_op(codegen.ctx, function->proto),
                        MIR_new_ref_op(codegen.ctx, function->func),
                        MIR_new_reg_op(codegen.ctx, dest), MIR_new_reg_op(codegen.ctx, expr),
                        MIR_new_reg_op(codegen.ctx, dest), MIR_new_reg_op(codegen.ctx, depth),
                        MIR_new_reg_op(codegen.ctx, list)));
    return;
  }
  case TYPE_OBJECT: {
    ...
    if (function)
    {
      ...
      MIR_append_insn(
        ...
        MIR_new_call_insn(codegen.ctx, 4, MIR_new_ref_op(codegen.ctx, function->proto),
                          ...
                          MIR_new_reg_op(codegen.ctx, tmp), MIR_new_reg_op(codegen.ctx, expr)));
...
static void generate_cast_expression(MIR_reg_t dest, CastExpr* expression)
{
  ...
  else if (expression->to_data_type.type == TYPE_STRING)
  {
    ...
    case TYPE_PROTOTYPE_TEMPLATE: {
      ...
      {
        depth = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(expression->from_data_type),
                                  codegen.function->u.func);

        MIR_append_insn(codegen.ctx, codegen.function,
                        MIR_new_insn(codegen.ctx, MIR_MOV, MIR_new_reg_op(codegen.ctx, depth),
                                     MIR_new_int_op(codegen.ctx, 0)));

        list = _MIR_new_temp_reg(codegen.ctx, data_type_to_mir_type(expression->from_data_type),
                                 codegen.function->u.func);
